      ...
      <ul>
        ...
        <li>
          <a
            ...
            data-option="advertisement"
            data-page="../pages/advertisement.html"
            className={selectedOption === 'advertisement' ? 'selected' : ''}
            onClick={(e) => {
              e.preventDefault();
              handleLinkClick('advertisement', '../pages/advertisement.html');
            }}
          >
            <span className="icon">
              <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
            ...
            <span className="link-text">Advertisement</span>
          </a>
        </li>
        <li>
          <a
